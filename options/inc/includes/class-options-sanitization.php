...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'ccb' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'ccb' ),
		'repeat-y'  => __( 'Repeat Vertically', 'ccb' ),
		'repeat'    => __( 'Repeat All', 'ccb' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'ccb' ),
		'top center'    => __( 'Top Center', 'ccb' ),
		'top right'     => __( 'Top Right', 'ccb' ),
		'center left'   => __( 'Middle Left', 'ccb' ),
		'center center' => __( 'Middle Center', 'ccb' ),
		'center right'  => __( 'Middle Right', 'ccb' ),
		'bottom left'   => __( 'Bottom Left', 'ccb' ),
		'bottom center' => __( 'Bottom Center', 'ccb' ),
		'bottom right'  => __( 'Bottom Right', 'ccb')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'ccb' ),
		'fixed'  => __( 'Fixed in Place', 'ccb')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'ccb' ),
		'italic'      => __( 'Italic', 'ccb' ),
		'bold'        => __( 'Bold', 'ccb' ),
		'bold italic' => __( 'Bold Italic', 'ccb' )
		);
