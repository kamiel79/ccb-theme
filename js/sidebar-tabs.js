jQuery( function ($) {
    ...
    $( '#tabbed-sidebar-widgets .widget-title a:first-child' ).addClass('first');

    $( '#tabbed-sidebar-widgets .widget-title a:last-child' ).addClass('last');
